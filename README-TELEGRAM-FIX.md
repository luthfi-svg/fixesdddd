...
## 2. Configure
Isi Environment Variables di Vercel: `TELEGRAM_BOT_TOKEN`, `TELEGRAM_ADMIN_IDS`, `TELEGRAM_WEBHOOK_SECRET` (opsional), `TELEGRAM_SETUP_KEY`, `GITHUB_TOKEN`, `GITHUB_GIST_ID`, dan `GITHUB_GIST_STATE_FILE` (opsional, default `site-state.json`).
